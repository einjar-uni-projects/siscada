...
/**
 * Elemento que representa la máquina expendedora de masa
...
public class PaintElementExpendedoraMasa extends PaintElement {
	 ...
	 */
	public PaintElementExpendedoraMasa(ImageLoader loader, int posX, int posY, int maxX, int maxY, MainFrameModel model) {
