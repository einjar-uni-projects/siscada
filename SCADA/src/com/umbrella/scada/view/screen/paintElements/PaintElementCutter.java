 ...
 * @version 1.0
 */
public class PaintElementCutter extends PaintElement {
	 ...
	 */
	public PaintElementCutter(ImageLoader loader, int posX, int posY,int maxX, int maxY, MainFrameModel model) {
		super(loader, posX, posY, maxX, maxY, model);
	}
	
	@Override
	public void paint(Graphics g) {
		g.drawImage(_loader.get_cortadora(), _posX, _posY, _maxX, _maxY, null);
