...
/**
 * Elemento que representa la máquina expendedora de chocolate
...
public class PaintElementExpendedoraChocolate extends PaintElement {
	 ...
	 */
	public PaintElementExpendedoraChocolate(ImageLoader loader, int posX, int posY,	int maxX, int maxY, MainFrameModel model) {
